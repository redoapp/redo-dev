...
| `returns_write`           | Write  | Create, update, and process returns; manage return tags and bundles.  |
...
| `checkout_read`           | Read   | List and retrieve checkout experiences and their shipping methods.    |
| `checkout_write`          | Write  | Create, update, and delete checkout experiences and shipping methods. |
