...
flowchart TD
    ...
    B -->|No| C["Contact support for your custom integration"]
    C --> E
...
### Standard RMA Creation

If you're not using a supported platform like Shopify, CommentSold, BigCommerce,
or CommentSold, contact our support team at
[support@redo.com](mailto:support@redo.com) for assistance with setting up your
integration
...
For unique requirements or unsupported platforms, contact support at
[support@redo.com](mailto:support@redo.com) to discuss custom integration
options and RMA workflows.
...
team at [support@redo.com](mailto:support@redo.com) or check our
