...
<IntegrationSupport providerSupport="For issues with Whiplash (Ryder) access, API credentials, order lookup feature enablement, or warehouse operations, contact your Whiplash (Ryder) account manager or support team." />
