...
```mermaid
flowchart TD
    A[Order Created in Your System] --> B[Transform Order Data]
...
<Steps>
  <Step title="Get API Credentials">
    Contact [support@redo.com](mailto:support@redo.com) to receive your API key
    and endpoint URL
  </Step>
...
[support@redo.com](mailto:support@redo.com) or check our
