...
flowchart TD
    ...
    B -->|Yes| E{Do you need to create an RMA in an external system?}
    E -->|No| F[You're Done!]
    E -->|Yes| G{Do we already have an integration for this system?}
    ...
    click C "/docs/guides/integrations/custom-integration"
...
<Card
  ...
  icon="code"
  href="/docs/guides/integrations/custom-integration"
>
