...
Send refunds you have already issued against the order in the `refunds` array.
    ...
    lineItems: [
      {
        ...
        totalTaxSet: {
          shopMoney: { amount: "1.60", currencyCode: "USD" },
          presentmentMoney: { amount: "1.60", currencyCode: "USD" },
        },
      },
    ],
    shippingRefunds: [],
