...
The AI creates the report and waits for completion before sharing the report
link. You can use the link to view the report or download a CSV.

If the proposed report omits or substitutes part of your request, the AI
explains the limitations and asks for your approval before creating it.
If the request cannot be supported, the AI asks you to revise the question.
...
The AI checks the requested changes and waits for the update to finish before
sharing the report link. If the changes cannot be supported, the report stays
unchanged and the AI asks you to revise the request.
