...
<AccordionGroup>
  ...
  <Accordion title="Cash Refund (optional, off by default)" icon="money-check-dollar">
    A Cash Refund is created in NetSuite when a return is marked complete in Redo. It links to the originating Return Authorization and includes only line items being refunded, with amounts and tax calculated automatically.
