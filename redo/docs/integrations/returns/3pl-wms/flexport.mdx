...
<Step title="Configure Shipping Locations (Optional)">
...
3. Edit the location and link it to the integration

This ensures returns are routed to the correct Flexport fulfillment center based on where the original order was shipped from. If you only have one fulfillment center, this step can be skipped.
</Step>
