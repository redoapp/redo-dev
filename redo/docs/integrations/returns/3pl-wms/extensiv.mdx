...
In your Redo dashboard, go to **Settings** → **Integrations** and select **Extensiv** from the integrations catalog.
</Step>

<Step title="Enter Your Credentials and Connect">
Click **Connect** on the **Returns** row to open the credentials form. Enter your Extensiv **Client ID**, **Client Secret**, **User Login**, **Customer ID**, and **Facility ID**, then click **Connect**. The client secret is stored securely and is not displayed again after saving. The integration shows **Connected** once the credentials are saved.
</Step>
