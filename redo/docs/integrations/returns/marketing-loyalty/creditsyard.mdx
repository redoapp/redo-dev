...
<Step title="Connect CreditsYard">
  ...
  **Integrations**. Find the CreditsYard integration and click **Connect**.
  ...
  ![Connect CreditsYard dialog](/docs/images/integrations/creditsyard/CreditsYard-Connect-Modal.png)
</Step>
...
<Step title="Select CreditsYard as Store Credit Type">
  ...
  ![Store credit type selection](/docs/images/integrations/creditsyard/CreditsYard-Return-Processing.png)
</Step>
</Steps>
